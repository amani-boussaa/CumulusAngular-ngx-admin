...
@NgModule({
  imports: [
    ...
    ThemeModule,
    TablesRoutingModule,
    Ng2SmartTableModule, NbTagModule,NbListModule,NbUserModule,NbButtonModule,FormsModule ,NbToastrModule,NbEvaIconsModule ,NbSelectModule,ReactiveFormsModule,NbActionsModule
